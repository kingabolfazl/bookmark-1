...
if(!empty($_GET['delete'])){
  $db->query('DELETE FROM bookmark WHERE ID = "'.$_GET['delete'].'"');
...
if(empty($_GET['search'])){
  echo "<div class='alert alert-danger alert-dismissable container col-sm-12' id='success-del'>
          ...
          <div class='col-sm-6 pull-right'>
            ...
            <a class='btn btn-sm bg-danger' data-dismiss='alert' href='admin.php?delete=".$_GET['delid']."&page=".$page."'><i class='text-danger glyphicon glyphicon-trash'></i></a>
...
if(!empty($_GET['search'])){
  echo "<div class='alert alert-danger alert-dismissable row' id='success-del'>
          ...
          <div class='col-sm-3 pull-right'>
            <div class='pull-right'>
            <a class='btn btn-sm bg-danger' data-dismiss='alert' href='admin.php?delete=".$_GET['delid']."&page=".$page."&search=".$_GET['search']."'><i class='text-danger glyphicon glyphicon-trash'></i></a>
            <a class='btn btn-sm bg-danger' data-dismiss='alert'><i class='text-danger glyphicon glyphicon-remove'></i></a>
            </div>
          </div>
        </div>";}}
